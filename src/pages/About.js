...
const About = () => {
  return (
    ...
    >
      ...
      <Grid container spacing={4} justifyContent="center" className="feature-grid">
          ...
          >
            <Card
              sx={{
                ...
                borderImage: 'linear-gradient(45deg, #00bfff, #1e90ff, #00bfff) 1',
            ...
            >
              <CardContent>
                <Typography variant="h6" gutterBottom sx={{ fontWeight: 'bold', color: '#00bfff' }}>
                  {feature.title}
                </Typography>
